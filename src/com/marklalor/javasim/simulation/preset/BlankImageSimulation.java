...
/**
 * <p>
 * Wrapper class for a {@link Simulation} with a predefined (default white)
 * background color.
 * </p>
 * <p>
 * The class:
...
public abstract class BlankImageSimulation extends Simulation
{
	...
	/**
	 * Fills the screen, from corner to corner, with the specified color (default
	 * white) when the simulation is reset (typically by Simulation→Reset).
	...
	/**
	 * @param backgroundColor The background color which fills image on {@link #reset()} 
	 */

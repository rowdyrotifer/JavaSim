...
public class SimulationInfo implements Serializable
{
    ...
    public SimulationInfo(Class<? extends Simulation> simulationClass)
    {
        ...
        setData(new File(SimulationInfo.findPathJar(simulationClass)), properties.get("name"), properties.get("main"), properties.get("date"), properties.get("author"), properties.get("version"),
...
//    }
     ...
     * 
     * 
     * If the provided class has been loaded from a jar file that is on the local file system, will find the absolute
     * path to that jar file.
     * 
     * @param context
     *            The jar file that contained the class file that represents this class will be found. Specify
     *            {@code null} to let {@code LiveInjector} find its own jar.
     * @throws IllegalStateException
     *             If the specified class was loaded from a directory or in some other way (such as via HTTP, from a
     *             database, or some other custom classloading device).
     */
    public static String findPathJar(Class<?> context) throws IllegalStateException
    {
        ...
        /*
         * rawName is something like package.name.ContainingClass$ClassName. We need to turn this into
         * ContainingClass$ClassName.class.
         */
        {

package com.marklalor.javasim.misc.image;
...
public class GifSequenceWriter
{
    ...
    // Converting the previous local contructor variables to fields to access
    // them to set the delay over and over.
    ...
    public GifSequenceWriter(ImageOutputStream outputStream, int imageType, int delay, boolean loopContinuously) throws IIOException, IOException
    {
        ...
        // graphicsControlExtensionNode.setAttribute("delayTime","8"); perhaps
        // should be 6?
        // see
